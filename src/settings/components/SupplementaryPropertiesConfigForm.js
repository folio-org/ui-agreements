...
class SupplementaryPropertiesConfigForm extends React.Component {
  ...
  sendCallout = (operation, outcome, error = '') => {
    this.callout.sendCallout({
      type: outcome,
      message: <FormattedMessage id={`ui-agreements.supplementaryProperties.callout.${operation}.${outcome}`} values={{ error }} />,
  ...
  sendCalloutInUse = () => {
    return (
      this.callout.sendCallout({
        type: 'error',
        message: <SafeHTMLMessage id="ui-agreements.supplementaryProperties.callout.delete.supplementaryPropertyInUse" />,
        timeout: 0,
      })
    );
  }
  ...
  render() {
    ...
    return (
      <Pane
        ...
        paneTitle={<FormattedMessage id="ui-agreements.section.supplementaryProperties" />}
        paneSub={<FormattedMessage id="ui-agreements.supplementaryProperties.count" values={{ count }} />}
      >
        <form>
          <FieldArray
            ...
            pickLists={pickLists}
            settingsRoute="supplementaryProperties"
          />
        </form>
