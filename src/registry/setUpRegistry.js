...
const setUpRegistry = (registry) => {
  ...
  remoteKbResource.setRenderFunction('tippTable', ({ resourceId, url, setBadgeCount }) => <RemoteResourceTIPPTable resourceId={resourceId} setBadgeCount={setBadgeCount} url={url} />);
