...
import DocFilterRuleConstants from '../DocFilterRuleConstants';
...
const DocFilterRule = ({
  ...
  const { operators, attributes } = DocFilterRuleConstants(atTypeValues.length > 0);
  return (
    <Row key={name}>
      <Col xs={2}>
