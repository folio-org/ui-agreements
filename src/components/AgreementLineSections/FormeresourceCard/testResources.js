...
const interalTitle = {
  ...
  const externalTitle = {
    ...
    'resource': {
      ...
      'packageId': '72-561',
      'packageName': 'Access World News Research Collection',
      'url': 'http://infoweb.newsbank.com/?db=AWNB&s_sources=location&d_place=LIYM',
      'providerId': 72,
      ...
      'managedCoverages': [
        {
          'beginCoverage': '2020-02-11',
          'endCoverage': '2020-03-25'
        }
      ],
      'customCoverages': '[]',
      'proxy': {
...
export { internalPackage, externalPackage, initialValuesData, line, handlers, initialValues, interalTitle, externalTitle };
