...
import { initialValues, handlers, data, data2 } from './testResources';
...
describe('FormEresource', () => {
    ...
    beforeEach(() => {
      renderComponent = renderWithIntl(
        <TestForm onSubmit={onSubmit}>
          <FormEresource agreementLineSource={data.agreementLineSource} line={data.line} lineId={data.lineId} setFieldData={data.setFieldData} values={data.values} />
        </TestForm>,
        translationsProperties
      );
    });
  ...
  describe('renders agreementLineSource type eholdings', () => {
    beforeEach(() => {
      renderComponent = renderWithIntl(
        <TestForm onSubmit={onSubmit}>
          <FormEresource agreementLineSource={data2.agreementLineSource} line={data2.line} lineId={data2.lineId} setFieldData={data2.setFieldData} values={data2.values} />
        </TestForm>,
        translationsProperties
      );
    });
