...
class Agreement extends React.Component {
  ...
  showCustpropAccordion = (customPropertyData) => {
            ...
            <TitleManager record={data.agreement.name}>
              ...
              <AccordionStatus ref={this.accordionStatusRef}>
                ...
                <AccordionSet initialStatus={this.getInitialAccordionsState()}>
                  ...
                  {this.showCustpropAccordion(data?.supplementaryProperties) && <SupplementaryProperties {...this.getSectionProps('supplementaryProperties')} />}
                  ...
                  {this.showCustpropAccordion(data?.openAccessProperties) && <SupplementaryProperties {...this.getSectionProps('openAccessProperties')} />}
