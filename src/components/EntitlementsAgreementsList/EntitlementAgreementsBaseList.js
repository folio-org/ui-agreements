...
const EntitlementAgreementsBaseList = (
  { entitlements,
    eresourceId,
    headline,
    id,
  ...
  return (
    <div style={{ minWidth: 0, width: '100%' }}> {/* prevent child MCL from expanding beyond container */}
      {renderHeadline()}
      <MultiColumnList
...
EntitlementAgreementsBaseList.propTypes = {
...
export default EntitlementAgreementsBaseList;
