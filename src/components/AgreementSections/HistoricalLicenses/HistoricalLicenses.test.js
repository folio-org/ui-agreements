...
import HistoricalLicenses from './HistoricalLicenses';

jest.mock('../../LinkedLicenseCard', () => () => <div>LinkedLicenseCard</div>);
...
const agreement = {
  ...
  'contacts': [],
  'tags': [],
  'lastUpdated': '2021-08-03T17:22:40Z',
  'inwardRelationships': [],
  ...
  'linkedLicenses': [
    {
      ...
      'amendments': [],
      'status': {
        'id': '2c9180bf7b0a10d8017b0a1164360020',
        'value': 'historical',
        'label': 'Historical'
      }
    },
...
describe('Historical Licenses', () => {
  beforeEach(() => {
    renderComponent = renderWithIntl(
      <HistoricalLicenses
        agreement={agreement}
        id="historicalLicenses"
      />,
  ...
  test('renders the LinkedLicenseCard component', () => {
    const { getByText } = renderComponent;
    expect(getByText('LinkedLicenseCard'));
  });
});
